...
application.add_handler(CommandHandler("cgbroadcast", gbroadcast, block=False))
...
application.add_handler(CommandHandler("cubroadcast", ubroadcast, block=False))
